            ...
            for (int i = 0; i < _H; ++i)
            {
                ...
                _opti.subject_to(_a(0, i) ==
                                 -(_F(0, i) + _F(1, i)) * sin(_x(2, i)) / _m +
                                   l(0));
                _opti.subject_to(_a(1, i) ==
                                 (_F(0, i) + _F(1, i)) * cos(_x(2, i)) / _m -
                                   _g + l(1));
                _opti.subject_to(_a(2, i) ==
                                 (_F(1, i) - _F(0, i)) * _l / (2 * _I) + l(2));
            }
        }
        else
        {
            for (int i = 0; i < _H; ++i)
            {
                _opti.subject_to(_a(0, i) ==
                                 -(_F(0, i) + _F(1, i)) * sin(_x(2, i)) / _m);
                _opti.subject_to(
                  _a(1, i) == (_F(0, i) + _F(1, i)) * cos(_x(2, i)) / _m - _g);
                _opti.subject_to(_a(2, i) ==
                                 (_F(1, i) - _F(0, i)) * _l / (2 * _I));
            }
        }

        for (int i = 1; i < _H + 1; ++i)
        {
            _opti.subject_to(_x(Slice(), i) ==
                             _x(Slice(), i - 1) + _u(Slice(), i - 1) * _dt +
                               0.5 * _a(Slice(), i - 1) * _dt * _dt);
            _opti.subject_to(_u(Slice(), i) ==
                             _u(Slice(), i - 1) + _a(Slice(), i - 1) * _dt);
        }
...
class NumOptimizer : public pq::Optimizer
{
  public:
      ...
      , _prev_result(DM::zeros(4, _H))
    {
        ...
        _model_params.segment(1, 9) =
          Eigen::Map<Eigen::VectorXd>(params.I.data(), 9);
        _model_params.segment(10, 9) =
          Eigen::Map<Eigen::VectorXd>(_I_inv.data(), 9);
  ...
  protected:
    ...
    void _setup(const Eigen::VectorXd &init, const Eigen::VectorXd &target)
    {
        ...
        DM init_x_dm = DM::vertcat(
          { init[0], init[1], init[2], init[3], init[4], init[5], init[6] });
        DM target_x_dm = DM::vertcat({ target[0],
                                       target[1],
                                       target[2],
                                       target[3],
                                       target[4],
        ...
        DM init_u_dm = DM::vertcat(
          { init[7], init[8], init[9], init[10], init[11], init[12] });
        DM target_u_dm = DM::vertcat({ target[7],
                                       target[8],
                                       target[9],
                                       target[10],
                                       target[11],
        ...
        _opti.subject_to(0 <= _c <=
                         quadrotor::Value::Param::NumOpt::control_max);

        _opti.subject_to(_x(Slice(), 0) == init_x_dm);
        //_opti.subject_to(sumsqr(_x(Slice(0, 3), _H) - target_x_dm(Slice(0,
        // 3))) <= 1e-6);
        _opti.subject_to(_u(Slice(), 0) == init_u_dm);
        ...
        if (learned_model.trained())
        {
            ...
            for (int i = 0; i < _H; ++i)
            {
                ...
                _opti.subject_to(
                  _F(0, i) ==
                  -2 * (_x(4, i) * _x(6, i) - _x(3, i) * _x(5, i)) * _m * _g);
                _opti.subject_to(
                  _F(1, i) ==
                  -2 * (_x(5, i) * _x(6, i) + _x(3, i) * _x(4, i)) * _m * _g);
                _opti.subject_to(
                  _F(2, i) ==
                  -2 * (_x(3, i) * _x(3, i) + _x(6, i) * _x(6, i)) * _m * _g +
                    _m * _g +
                    _Kf * (_c(0, i) + _c(1, i) + _c(2, i) + _c(3, i)));

                // TORQUE
                _opti.subject_to(_F(3, i) == _l * _Kf * (_c(1, i) - _c(3, i)));
                _opti.subject_to(_F(4, i) == _l * _Kf * (_c(2, i) - _c(0, i)));
                _opti.subject_to(_F(5, i) == _Kt * (_c(0, i) - _c(1, i) +
                                                    _c(2, i) - _c(3, i)));

                // LINEAR ACCELERATION
                _opti.subject_to(_a(0, i) ==
                                 _F(0, i) / _m -
                                   (_u(4, i) * _u(2, i) - _u(5, i) * _u(1, i)) +
                                   l(0));
                _opti.subject_to(_a(1, i) ==
                                 _F(1, i) / _m -
                                   (_u(5, i) * _u(0, i) - _u(3, i) * _u(2, i)) +
                                   l(1));
                _opti.subject_to(_a(2, i) ==
                                 _F(2, i) / _m -
                                   (_u(3, i) * _u(1, i) - _u(4, i) * _u(0, i)) +
                                   l(2));

                // ANGULAR ACCELERATION
                // [wix, wiy, wiz] = inertia * angular_velocity
                MX wix = _I(0, 0) * _u(3, i) + _I(0, 1) * _u(4, i) +
                         _I(0, 2) * _u(5, i);
                MX wiy = _I(1, 0) * _u(3, i) + _I(1, 1) * _u(4, i) +
                         _I(1, 2) * _u(5, i);
                MX wiz = _I(2, 0) * _u(3, i) + _I(2, 1) * _u(4, i) +
                         _I(2, 2) * _u(5, i);

                // [fx, fy, fz] = torque - angular_velocity.cross(inertia *
                // angular_velocity)
                MX fx = _F(3, i) - (_u(4, i) * wiz - _u(5, i) * wiy);
                MX fy = _F(4, i) - (_u(5, i) * wix - _u(3, i) * wiz);
                MX fz = _F(5, i) - (_u(3, i) * wiy - _u(4, i) * wix);

                _opti.subject_to(_a(3, i) == _I_inv(0, 0) * fx +
                                               _I_inv(0, 1) * fy +
                                               _I_inv(0, 2) * fz + l(3));
                _opti.subject_to(_a(4, i) == _I_inv(1, 0) * fx +
                                               _I_inv(1, 1) * fy +
                                               _I_inv(1, 2) * fz + l(4));
        ...
        for (int i = 1; i < _H + 1; ++i)
        {
            ...
            // POSITION UPDATE
            _opti.subject_to(
              _x(0, i) == _x(0, i - 1) + ((2 * (_x(3, i - 1) * _x(3, i - 1) +
                                                _x(4, i - 1) * _x(4, i - 1)) -
                                           1) *
                                            _u(0, i) +
                                          (2 * (_x(4, i - 1) * _x(5, i - 1) -
                                          ...
                                          (2 * (_x(4, i - 1) * _x(6, i - 1) +
                                           ...
                                           _dt);
            _opti.subject_to(
              _x(1, i) == _x(1, i - 1) + ((2 * (_x(4, i - 1) * _x(5, i - 1) +
                                                _x(3, i - 1) * _x(6, i - 1))) *
                                            _u(0, i) +
                                          (2 * (_x(3, i - 1) * _x(3, i - 1) +
                                                _x(5, i - 1) * _x(5, i - 1)) -
                                          ...
                                          (2 * (_x(5, i - 1) * _x(6, i - 1) -
                                           ...
                                           _dt);
            _opti.subject_to(
              _x(2, i) == _x(2, i - 1) + ((2 * (_x(4, i - 1) * _x(6, i - 1) -
                                                _x(3, i - 1) * _x(5, i - 1))) *
                                            _u(0, i) +
                                          (2 * (_x(5, i - 1) * _x(6, i - 1) +
                                                _x(3, i - 1) * _x(4, i - 1))) *
            ...
            q(0) = _x(3, i - 1) +
                   0.5 *
                     (-_x(4, i - 1) * _u(3, i) - _x(5, i - 1) * _u(4, i) -
                      _x(6, i - 1) * _u(5, i)) *
                     _dt;
            q(1) = _x(4, i - 1) +
                   0.5 *
                     (_x(3, i - 1) * _u(3, i) - _x(6, i - 1) * _u(4, i) +
                      _x(5, i - 1) * _u(5, i)) *
                     _dt;
            q(2) = _x(5, i - 1) +
                   0.5 *
                     (_x(6, i - 1) * _u(3, i) + _x(3, i - 1) * _u(4, i) -
                      _x(4, i - 1) * _u(5, i)) *
                     _dt;
            q(3) = _x(6, i - 1) +
                   0.5 *
                     (-_x(5, i - 1) * _u(3, i) + _x(4, i - 1) * _u(4, i) +
                      _x(3, i - 1) * _u(5, i)) *
                     _dt;

            _opti.subject_to(_x(Slice(3, 7), i) ==
                             q /
                               if_else(norm_2(q) > 1e-6, norm_2(q), 1.0, true));
        }

        if (_prev)
        {
            for (int i = 0;
                 i < quadrotor::Value::Param::NumOpt::prev_steps_init;
                 ++i)
            {
